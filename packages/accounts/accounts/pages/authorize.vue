        ...
        <w-grid-column :cols="5">
          <w-card :shadow="false">
            ...
            <w-card-body>
              ...
              <template v-for="item of [1, 2]">
                <w-spacer :key="`${item}-spacer`"></w-spacer>
                <w-grid-row :key="item">
                  <w-grid-column>
                    <w-text>
                      View and manage your data across Xarples console services.
                    </w-text>
                  </w-grid-column>
                </w-grid-row>
              </template>
              ...
              <w-text>
                ...
                its terms of service and privacy policies. You can always see or
                remove access in your
              </w-text>
            </w-card-body>
            <w-card-footer>
              <form
